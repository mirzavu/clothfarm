...
class ControllerCommonDashboard extends Controller {
	public function index() { 
		...
		//$data['user'] = $this->load->controller('dashboard/user');
		...
		$data['rate'] = $this->load->controller('dashboard/rate');
		$data['return'] = $this->load->controller('dashboard/return');
		
		$data['vendor'] = $this->load->controller('dashboard/vendor');
		$data['brand'] = $this->load->controller('dashboard/brand');
		$data['shipping'] = $this->load->controller('dashboard/shipping');
		$data['debit'] = $this->load->controller('dashboard/debit');
		$data['commission'] = $this->load->controller('dashboard/commission');	
		$data['tickets'] = $this->load->controller('dashboard/tickets');
		$data['best_seller'] = $this->load->controller('dashboard/best_seller');
		$data['most_purchased'] = $this->load->controller('dashboard/most_purchased');
		$data['most_viewed'] = $this->load->controller('dashboard/most_viewed');	
