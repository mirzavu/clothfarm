...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_manage_statuses'] = $this->language->get('text_manage_statuses');
		...
		$data['text_vendor_reports'] = $this->language->get('text_vendor_reports');
		$data['text_vendor_products'] = $this->language->get('text_vendor_products');
		$data['text_vendor_orders'] = $this->language->get('text_vendor_orders');
		...
		$data['text_pay_seller'] = $this->language->get('text_pay_seller');
		...
		$data['text_subscribe_plan'] = $this->language->get('text_subscribe_plan');
		$data['vendor_subscribe_plan'] = $this->language->get('vendor_subscribe_plan');
		$data['text_autopost_plan'] = $this->language->get('text_autopost_plan');
		$data['vendor_autopost_plan'] = $this->language->get('vendor_autopost_plan');
		
		$data['subscribe_plan'] = $this->url->link('subscribe/plan', 'token=' . $this->session->data['token'], 'SSL');
		$data['vendor_plan'] = $this->url->link('subscribe/plan/vendor_list', 'token=' . $this->session->data['token'], 'SSL');
		$data['autopost_plan'] = $this->url->link('autopost/plan', 'token=' . $this->session->data['token'], 'SSL');
		$data['vendor_autopost'] = $this->url->link('autopost/plan/vendor_list', 'token=' . $this->session->data['token'], 'SSL');
		$data['bank_details'] = $this->url->link('catalog/bank_details', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['seller_review'] = $this->url->link('catalog/seller_review', 'token=' . $this->session->data['token'], 'SSL');
...
$data['category'] = $this->url->link('catalog/mcategory', 'token=' . $this->session->data['token'], 'SSL');			
		...
		$data['general_settings'] = $this->url->link('setting/setting', 'token=' . $this->session->data['token'], 'SSL');
...
$data['product'] = $this->url->link('catalog/mproduct', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['manage_vendors'] = $this->url->link('setting/store/vendors', 'token=' . $this->session->data['token'], 'SSL');	
		...
		$data['report_vendor_products'] = $this->url->link('report/vendorwise_product', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_vendor_orders'] = $this->url->link('report/vendorwise_order', 'token=' . $this->session->data['token'], 'SSL');
		$data['sales_commission'] = $this->url->link('funds/sales_commission', 'token=' . $this->session->data['token'], 'SSL');
		$data['sales_debits'] = $this->url->link('funds/vendor_payment/debits', 'token=' . $this->session->data['token'], 'SSL');
		$data['vendor_payments'] = $this->url->link('funds/vendor_payment', 'token=' . $this->session->data['token'], 'SSL');
		$data['pay_seller'] = $this->url->link('funds/pay_seller', 'token=' . $this->session->data['token'], 'SSL');
		$data['tickets'] = $this->url->link('tickets/tickets', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['text_vendor_shipping_rate'] = $this->language->get('text_vendor_shipping_rate');
		$data['vendor_shipping_rate'] = $this->url->link('localisation/vendor_shipping_rate', 'token=' . $this->session->data['token'], 'SSL');
