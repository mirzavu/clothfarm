...
<li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
	<ul>
		...
		<li><a href="<?php echo $vendor_shipping_rate; ?>"><?php echo $text_vendor_shipping_rate; ?></a></li>
...
<li id="vendors"><a class="parent"><i class="fa fa-bank fa-fw"></i> <span><?php echo $text_vendors; ?></span></a>
	<ul>
		...
		<li><a href="<?php echo $subscribe_plan; ?>"><?php echo $text_subscribe_plan; ?></a></li>
		<li><a href="<?php echo $vendor_plan; ?>"><?php echo $vendor_subscribe_plan; ?></a></li>
		<li><a href="<?php echo $autopost_plan; ?>"><?php echo $text_autopost_plan; ?></a></li>
		<li><a href="<?php echo $vendor_autopost; ?>"><?php echo $vendor_autopost_plan; ?></a></li>
	</ul>
</li>
