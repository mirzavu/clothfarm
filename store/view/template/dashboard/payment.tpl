...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      <ul id="payments" class="dropdown-menu dropdown-menu-right">
  ...
  <div class="panel-body">
    <div id="statistics" width='100%' style="width: 100%; height: 260px;">	</div>
  </div>
</div>
...
var chart;
$('#payments a').on('click', function(e) { 
	e.preventDefault();
	...
	$.ajax({
		type: 'get',
		url: 'index.php?route=dashboard/payment/getStatistics&token=<?php echo $token; ?>&range=' + $(this).attr('href'),
		dataType: 'json',
...
$('#payments .active a').trigger('click');	
