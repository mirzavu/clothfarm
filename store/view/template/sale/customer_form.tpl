...
<?php if ($customer_id && $can_edit != $sdID) { ?>
$('#customerfieldedit').find('input, textarea, button, select').attr('disabled','disabled');
<?php } ?>
