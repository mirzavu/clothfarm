                  ...
                  <div class="tab-pane active" id="tab-general">
                     ...
                     <div class="form-group" style="display:none;">
                        ...
                        <div class="col-sm-10">
                           ...
                           <div class="text-danger"><?php echo $error_product_store; ?></div>
                           <?php }  ?>
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                           ...
                           <tbody>
                              ...
                              <tr id="recurring-row<?php echo $recurring_row; ?>">
                                 <td class="text-left">
                                    <select name="product_recurring[<?php echo $recurring_row; ?>][recurring_id]" class="form-control">
                                 ...
                                 <td class="text-left">
                                    <select name="product_recurring[<?php echo $recurring_row; ?>][customer_group_id]" class="form-control">
                                       <?php foreach ($customer_groups as $customer_group) { ?>
