              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
		 <td class="text-right"><?php echo $column_st_name; ?></td>		
...
<?php if($category['can_edit_cat'] == 1){ ?>
...
<?php } ?>
		  ...
		  <td class="text-left"><?php if($category['can_edit_cat'] != 1){ echo $column_st_default; }else{ echo $store_name_posted; } ?></td>	
