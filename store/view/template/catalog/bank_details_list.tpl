...
<?php if($bank_details['can_edit_cat'] == 1){ ?>
<?php if (in_array($bank_details['bank_details_id'], $selected)) { ?>
 ...
 <?php } ?>
                  ...
                  <td class="text-right"><?php echo $bank_details['sort_order']; ?></td>

<td class="text-right">
<?php if($bank_details['can_edit_cat'] == 1){ ?>
<a href="<?php echo $bank_details['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
<?php } ?>
</td>
                </tr>
                <?php } ?>
