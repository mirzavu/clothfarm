		...
		<td class="text-right"><?php echo $column_vendor_earnings; ?></td>
		 ...
		 <td class="text-right"><?php echo $column_balance; ?></td>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-left"><?php echo $site_commission['store']; ?></td>
                <td class="text-left"><?php echo $site_commission['vendor']; ?></td>
                <td class="text-left"><?php echo $site_commission['email']; ?></td>                                
