...
<script type="text/javascript" src="view/javascript/jquery/highchart/highcharts.js"></script> 
<script type="text/javascript" src="view/javascript/jquery/highchart/exporting.js"></script>
<link href="view/javascript/bootstrap/exlcart/exlcart.css" type="text/css" rel="stylesheet" />
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
   <div class="logopanel" >
    <h1 class="logotitle"><a  class="">Clothfarm</a></h1>
   </div>	
 <?php if ($logged) { ?>
...
<div class="headerright" >
  ...
  <?php  /*<li class="dropdown liadjust">

<a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
