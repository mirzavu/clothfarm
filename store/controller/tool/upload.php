...
class ControllerToolUpload extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('tool/upload', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/upload', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['delete'] = $this->url->link('tool/upload/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['uploads'][] = array(
				...
				'download'   => $this->url->link('tool/upload/download', 'token=' . $this->session->data['mtoken'] . '&code=' . $result['code'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('tool/upload', 'token=' . $this->session->data['mtoken'] . '&sort=name' . $url, 'SSL');
		$data['sort_filename'] = $this->url->link('tool/upload', 'token=' . $this->session->data['mtoken'] . '&sort=filename' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('tool/upload', 'token=' . $this->session->data['mtoken'] . '&sort=date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('tool/upload', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function validateDelete() {
		if (!$this->merchant->hasPermission('modify', 'tool/upload')) {
