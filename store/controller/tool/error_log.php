...
class ControllerToolErrorLog extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/error_log', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['clear'] = $this->url->link('tool/error_log/clear', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	public function clear() {
		...
		if (!$this->merchant->hasPermission('modify', 'tool/error_log')) {
		...
		$this->response->redirect($this->url->link('tool/error_log', 'token=' . $this->session->data['mtoken'], 'SSL'));
	}
}
