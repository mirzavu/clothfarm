...
class ControllerToolBackup extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->merchant->hasPermission('modify', 'tool/backup')) {
			...
			if ($content) {
				...
				$this->response->redirect($this->url->link('tool/backup', 'token=' . $this->session->data['mtoken'], 'SSL'));
			} else {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/backup', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['restore'] = $this->url->link('tool/backup', 'token=' . $this->session->data['mtoken'], 'SSL');

		$data['backup'] = $this->url->link('tool/backup/backup', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	public function backup() {
		...
		if (!isset($this->request->post['backup'])) {
			...
			$this->response->redirect($this->url->link('tool/backup', 'token=' . $this->session->data['mtoken'], 'SSL'));
		} elseif ($this->merchant->hasPermission('modify', 'tool/backup')) {
