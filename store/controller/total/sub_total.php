...
class ControllerTotalSubTotal extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('total/sub_total', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['action'] = $this->url->link('total/sub_total', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	protected function validate() {
		if (!$this->merchant->hasPermission('modify', 'total/sub_total')) {
