<?php
class ControllerMerchantReset extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($user_info) {
			$this->load->language('merchant/reset');
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('merchant/reset', '', 'SSL')
			);
			...
			$data['action'] = $this->url->link('merchant/reset', 'code=' . $code, 'SSL');
			...
			$this->response->setOutput($this->load->view('merchant/reset.tpl', $data));
		} else {
