...
class ControllerPaymentPPStandard extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/pp_standard', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['action'] = $this->url->link('payment/pp_standard', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	private function validate() {
		if (!$this->merchant->hasPermission('modify', 'payment/pp_standard')) {
