...
class ControllerPaymentPPExpress extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/pp_express', 'token=' . $this->session->data['mtoken'], 'SSL'),
		);

		$data['action'] = $this->url->link('payment/pp_express', 'token=' . $this->session->data['mtoken'], 'SSL');
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['mtoken'], 'SSL');
		$data['search'] = $this->url->link('payment/pp_express/search', 'token=' . $this->session->data['mtoken'], 'SSL');
		...
		$data['text_paypal_link'] = 'https://www.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?'
				...
				. '&returnToPartnerUrl=' . base64_encode(html_entity_decode($this->url->link('payment/pp_express/live', 'token=' . $this->session->data['mtoken'], 'SSL')))
		...
		$data['text_paypal_link_sandbox'] = 'https://www.sandbox.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?'
				...
				. '&productIntentID=addipmt'
				. '&receiveCredentials=TRUE'
				. '&returnToPartnerUrl=' . base64_encode(html_entity_decode($this->url->link('payment/pp_express/sandbox', 'token=' . $this->session->data['mtoken'], 'SSL')))
				. '&subIntegrationType=S';
	...
	protected function validate() {
		if (!$this->merchant->hasPermission('modify', 'payment/pp_express')) {
	...
	public function live() {
		...
		$this->response->redirect($this->url->link('payment/pp_express', 'token=' . $this->session->data['mtoken'], 'SSL'));
	}
	...
	public function refund() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('payment/pp_express/refund', 'token=' . $this->session->data['mtoken'], 'SSL'),
		);

		//button actions
		$data['action'] = $this->url->link('payment/pp_express/doRefund', 'token=' . $this->session->data['mtoken'], 'SSL');
		$data['cancel'] = $this->url->link('payment/pp_express', 'token=' . $this->session->data['mtoken'], 'SSL');
			...
			if ($this->request->post['refund_full'] == 0 && $this->request->post['amount'] == 0) {
				...
				if ($paypal_order) {
					...
					if ($result == false) {
						...
						$this->response->redirect($this->url->link('payment/pp_express/refund', 'token=' . $this->session->data['mtoken'] . '&transaction_id=' . $this->request->post['transaction_id'], 'SSL'));
					}
				} else {
	...
	public function orderAction() {
		if ($this->config->get('pp_express_status')) {
			...
			if ($paypal_order) {
				...
				$data['refund_link'] = $this->url->link('payment/pp_express/refund', 'token=' . $this->session->data['mtoken'], 'SSL');
				$data['view_link'] = $this->url->link('payment/pp_express/viewTransaction', 'token=' . $this->session->data['mtoken'], 'SSL');
				$data['resend_link'] = $this->url->link('payment/pp_express/resend', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	public function search() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('payment/pp_express/search', 'token=' . $this->session->data['mtoken'], 'SSL'),
		);
	...
	public function viewTransaction() {
		...
		$data['view_link'] = $this->url->link('payment/pp_express/viewTransaction', 'token=' . $this->session->data['mtoken'], 'SSL');
		$data['cancel'] = $this->url->link('payment/pp_express/search', 'token=' . $this->session->data['mtoken'], 'SSL');
		$data['token'] = $this->session->data['mtoken'];
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('payment/pp_express/viewTransaction', 'token=' . $this->session->data['mtoken'] . '&transaction_id=' . $this->request->get['transaction_id'], 'SSL'),
		);
	...
	public function recurringButtons() {
		...
		return $this->load->view('merchant/buttons.tpl', $data);
	}
}
