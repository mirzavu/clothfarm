...
class ControllerPaymentSecureTradingPp extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/securetrading_pp', 'token=' . $this->session->data['mtoken'], 'SSL')
		);
		...
		$data['action'] = $this->url->link('payment/securetrading_pp', 'token=' . $this->session->data['mtoken'], 'SSL');
