...
class ControllerPaymentFirstdata extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/firstdata', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['action'] = $this->url->link('payment/firstdata', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	public function orderAction() {
		if ($this->config->get('firstdata_status')) {
			...
			if (!empty($firstdata_order)) {
				...
				$data['void_url'] = $this->url->link('payment/firstdata/void', 'token=' . $this->session->data['mtoken'], 'SSL');
				$data['capture_url'] = $this->url->link('payment/firstdata/capture', 'token=' . $this->session->data['mtoken'], 'SSL');
				$data['notify_url'] = HTTPS_CATALOG . 'index.php?route=payment/firstdata/notify';
	...
	public function void() {
		...
		$this->response->redirect($this->url->link('sale/order/info', 'order_id=' . $this->request->post['order_id'] . '&token=' . $this->session->data['mtoken'], 'SSL'));
	}
	...
	protected function validate() {
		if (!$this->merchant->hasPermission('modify', 'payment/firstdata')) {
