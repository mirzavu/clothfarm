...
class ControllerPaymentKlarnaInvoice extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/klarna_invoice', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['action'] = $this->url->link('payment/klarna_invoice', 'token=' . $this->session->data['mtoken'], 'SSL');
		...
		$data['clear'] = $this->url->link('payment/klarna_invoice/clear', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	private function validate() {
		if (!$this->merchant->hasPermission('modify', 'payment/klarna_invoice')) {
	...
	public function clear() {
		...
		$this->response->redirect($this->url->link('payment/klarna_invoice', 'token=' . $this->session->data['mtoken'], 'SSL'));
	}
}
