...
class ControllerPaymentTwoCheckout extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/twocheckout', 'token=' . $this->session->data['mtoken'], 'SSL')
		);

		$data['action'] = $this->url->link('payment/twocheckout', 'token=' . $this->session->data['mtoken'], 'SSL');
	...
	protected function validate() {
		if (!$this->merchant->hasPermission('modify', 'payment/twocheckout')) {
