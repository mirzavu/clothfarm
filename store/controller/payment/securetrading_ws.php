...
class ControllerPaymentSecureTradingWs extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/securetrading_ws', 'token=' . $this->session->data['mtoken'], 'SSL')
		);
		...
		$data['action'] = $this->url->link('payment/securetrading_ws', 'token=' . $this->session->data['mtoken'], 'SSL');

		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['mtoken']);
		...
		if ($response) {
			...
			foreach ($csv as $row) {
				$data['transactions'][] = array(
					...
					'order_href' => $this->url->link('sale/order/info', 'token=' . $this->session->data['mtoken'] . '&order_id=' . $row['orderreference'], 'SSL'),
	...
	protected function validate() {
		if (!$this->merchant->hasPermission('modify', 'payment/securetrading_pp')) {
