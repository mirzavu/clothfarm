...
class ControllerCatalogRecurring extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/recurring', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/recurring', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('catalog/recurring/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['copy'] = $this->url->link('catalog/recurring/copy', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('catalog/recurring/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['recurrings'][] = array(
				...
				'edit'         => $this->url->link('catalog/recurring/edit', 'token=' . $this->session->data['mtoken'] . '&recurring_id=' . $result['recurring_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=pd.name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('catalog/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('catalog/recurring', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['recurring_id'])) {
			$data['action'] = $this->url->link('catalog/recurring/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('catalog/recurring/edit', 'token=' . $this->session->data['mtoken'] . '&recurring_id=' . $this->request->get['recurring_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('catalog/recurring', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'catalog/recurring')) {
