...
class ControllerMarketingCoupon extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('marketing/coupon/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('marketing/coupon/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['coupons'][] = array(
				...
				'edit'       => $this->url->link('marketing/coupon/edit', 'token=' . $this->session->data['mtoken'] . '&coupon_id=' . $result['coupon_id'] . $url, 'SSL'),
				'can_edit'   => $result['vendor_id'],
			);
		}
		...
		$data['sort_name'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . '&sort=name' . $url, 'SSL');
		$data['sort_code'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . '&sort=code' . $url, 'SSL');
		$data['sort_discount'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . '&sort=discount' . $url, 'SSL');
		$data['sort_date_start'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . '&sort=date_start' . $url, 'SSL');
		$data['sort_date_end'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . '&sort=date_end' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . '&sort=status' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['coupon_id'])) {
			$data['action'] = $this->url->link('marketing/coupon/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('marketing/coupon/edit', 'token=' . $this->session->data['mtoken'] . '&coupon_id=' . $this->request->get['coupon_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		if (!empty($coupon_info)) { 
			$data['can_edit'] = $coupon_info['vendor_id']; 
		} else {
			$data['can_edit'] = '';
		}
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'marketing/coupon')) {
		...
		if(isset($this->request->post['coupon_product'])){}else{
	...
	public function history() {
		...
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('marketing/coupon/history', 'token=' . $this->session->data['mtoken'] . '&coupon_id=' . $this->request->get['coupon_id'] . '&page={page}', 'SSL');
