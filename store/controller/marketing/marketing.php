...
class ControllerMarketingMarketing extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('marketing/marketing/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('marketing/marketing/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'edit'         => $this->url->link('marketing/marketing/edit', 'token=' . $this->session->data['mtoken'] . '&marketing_id=' . $result['marketing_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . '&sort=m.name' . $url, 'SSL');
		$data['sort_code'] = $this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . '&sort=m.code' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . '&sort=m.date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['marketing_id'])) {
			$data['action'] = $this->url->link('marketing/marketing/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('marketing/marketing/edit', 'token=' . $this->session->data['mtoken'] . '&marketing_id=' . $this->request->get['marketing_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('marketing/marketing', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'marketing/marketing')) {
