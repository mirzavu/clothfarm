...
class ControllerReportCustomerOnline extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('report/customer_online', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'),
		...
		foreach ($results as $result) {
			...
			$data['customers'][] = array(
				...
				'edit'        => $this->url->link('sale/customer/edit', 'token=' . $this->session->data['mtoken'] . '&customer_id=' . $result['customer_id'], 'SSL')
			);
		}
		...
		$pagination->url = $this->url->link('report/customer_online', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
