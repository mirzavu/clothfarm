...
class ControllerReportSaleOrder extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/sale_order', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'main_total' => $this->currency->format($result['main_total'], $this->config->get('config_currency'))
			);
		}
		...
		$data['column_main_total'] = $this->language->get('column_main_total');
		...
		$pagination->url = $this->url->link('report/sale_order', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
