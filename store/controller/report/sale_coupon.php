...
class ControllerReportSaleCoupon extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/sale_coupon', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('report/sale_coupon', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
