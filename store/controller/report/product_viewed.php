...
class ControllerReportProductViewed extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/product_viewed', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);
		...
		$data['reset'] = $this->url->link('report/product_viewed/reset', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		$pagination->url = $this->url->link('report/product_viewed', 'token=' . $this->session->data['mtoken'] . '&page={page}', 'SSL');
	...
	public function reset() {
		...
		if (!$this->merchant->hasPermission('modify', 'report/product_viewed')) {
		...
		$this->response->redirect($this->url->link('report/product_viewed', 'token=' . $this->session->data['mtoken'], 'SSL'));
	}
}
