...
class ControllerReportCustomerOrder extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/customer_order', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('report/customer_order', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
