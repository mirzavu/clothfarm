...
class ControllerLocalisationCurrency extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('localisation/currency/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('localisation/currency/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['refresh'] = $this->url->link('localisation/currency/refresh', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['currencies'][] = array(
				...
				'edit'          => $this->url->link('localisation/currency/edit', 'token=' . $this->session->data['mtoken'] . '&currency_id=' . $result['currency_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_title'] = $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . '&sort=title' . $url, 'SSL');
		$data['sort_code'] = $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . '&sort=code' . $url, 'SSL');
		$data['sort_value'] = $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . '&sort=value' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . '&sort=date_modified' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['currency_id'])) {
			$data['action'] = $this->url->link('localisation/currency/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('localisation/currency/edit', 'token=' . $this->session->data['mtoken'] . '&currency_id=' . $this->request->get['currency_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('localisation/currency', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'localisation/currency')) {
