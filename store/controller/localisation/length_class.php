...
class ControllerLocalisationLengthClass extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('localisation/length_class/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('localisation/length_class/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['length_classes'][] = array(
				...
				'unit'            => $result['unit'],
				'value'           => $result['value'],
				'edit'            => $this->url->link('localisation/length_class/edit', 'token=' . $this->session->data['mtoken'] . '&length_class_id=' . $result['length_class_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_title'] = $this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . '&sort=title' . $url, 'SSL');
		$data['sort_unit'] = $this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . '&sort=unit' . $url, 'SSL');
		$data['sort_value'] = $this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . '&sort=value' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
		...
		$data['sort'] = $sort;
		$data['order'] = $order;		$data['header'] = $this->load->controller('merchant/header');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['length_class_id'])) {
			$data['action'] = $this->url->link('localisation/length_class/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('localisation/length_class/edit', 'token=' . $this->session->data['mtoken'] . '&length_class_id=' . $this->request->get['length_class_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('localisation/length_class', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'localisation/length_class')) {
