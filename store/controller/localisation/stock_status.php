...
class ControllerLocalisationStockStatus extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/stock_status', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/stock_status', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('localisation/stock_status/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('localisation/stock_status/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['stock_statuses'][] = array(
				...
				'name'            => $result['name'],
				'edit'            => $this->url->link('localisation/stock_status/edit', 'token=' . $this->session->data['mtoken'] . '&stock_status_id=' . $result['stock_status_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/stock_status', 'token=' . $this->session->data['mtoken'] . '&sort=name' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('localisation/stock_status', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['stock_status_id'])) {
			$data['action'] = $this->url->link('localisation/stock_status/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('localisation/stock_status/edit', 'token=' . $this->session->data['mtoken'] . '&stock_status_id=' . $this->request->get['stock_status_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('localisation/stock_status', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'localisation/stock_status')) {
