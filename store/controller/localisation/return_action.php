...
class ControllerLocalisationReturnAction extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/return_action', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/return_action', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('localisation/return_action/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('localisation/return_action/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['return_actions'][] = array(
				...
				'name'             => $result['name'],
				'edit'             => $this->url->link('localisation/return_action/edit', 'token=' . $this->session->data['mtoken'] . '&return_action_id=' . $result['return_action_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/return_action', 'token=' . $this->session->data['mtoken'] . '&sort=name' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('localisation/return_action', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['return_action_id'])) {
			$data['action'] = $this->url->link('localisation/return_action/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('localisation/return_action/edit', 'token=' . $this->session->data['mtoken'] . '&return_action_id=' . $this->request->get['return_action_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('localisation/return_action', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'localisation/return_action')) {
