...
class ControllerSaleRecurring extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'),
		);
		...
		foreach ($results as $result) {
			...
			$data['recurrings'][] = array(
				...
				'order_link'         => $this->url->link('sale/order/info', 'token=' . $this->session->data['mtoken'] . '&order_id=' . $result['order_id'], 'SSL'),
				'reference'          => $result['reference'],
				'customer'           => $result['customer'],
				'status'             => $result['status'],
				'date_added'         => $date_added,
				'view'               => $this->url->link('sale/recurring/info', 'token=' . $this->session->data['mtoken'] . '&order_recurring_id=' . $result['order_recurring_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_order_recurring'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=or.order_recurring_id' . $url, 'SSL');
		$data['sort_order'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=or.order_id' . $url, 'SSL');
		$data['sort_reference'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=or.reference' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=customer' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=or.status' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&sort=or.date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . '&page={page}' . $url, 'SSL');
	...
	public function info() {
		...
		if ($order_recurring) {
			...
			$data['order_href'] = $this->url->link('sale/order/info', 'token=' . $this->session->data['mtoken'] . '&order_id=' . $order['order_id'], 'SSL');
			...
			if ($order['customer_id']) {
				$data['customer_href'] = $this->url->link('sale/customer/edit', 'token=' . $this->session->data['mtoken'] . '&customer_id=' . $order['customer_id'], 'SSL');
			} else {
				$data['customer_href'] = '';
			}

			if ($order_recurring['recurring_id'] != '0') {
				$data['recurring'] = $this->url->link('catalog/recurring/edit', 'token=' . $this->session->data['mtoken'] . '&recurring_id=' . $order_recurring['recurring_id'], 'SSL');
			} else {
				$data['recurring'] = '';
			}
			...
			$data['return'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
