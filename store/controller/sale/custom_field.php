...
class ControllerSaleCustomField extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('sale/custom_field/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('sale/custom_field/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$data['custom_fields'][] = array(
				...
				'edit'            => $this->url->link('sale/custom_field/edit', 'token=' . $this->session->data['mtoken'] . '&custom_field_id=' . $result['custom_field_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . '&sort=cfd.name' . $url, 'SSL');
		$data['sort_location'] = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . '&sort=cf.location' . $url, 'SSL');
		$data['sort_type'] = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . '&sort=cf.type' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . '&sort=cf.status' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . '&sort=cf.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['custom_field_id'])) {
			$data['action'] = $this->url->link('sale/custom_field/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('sale/custom_field/edit', 'token=' . $this->session->data['mtoken'] . '&custom_field_id=' . $this->request->get['custom_field_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('sale/custom_field', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'sale/custom_field')) {
