...
class ControllerDesignLayout extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('design/layout', 'token=' . $this->session->data['mtoken'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('design/layout', 'token=' . $this->session->data['mtoken'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('design/layout/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		$data['delete'] = $this->url->link('design/layout/delete', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['layouts'][] = array(
				...
				'name'      => $result['name'],
				'edit'      => $this->url->link('design/layout/edit', 'token=' . $this->session->data['mtoken'] . '&layout_id=' . $result['layout_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('design/layout', 'token=' . $this->session->data['mtoken'] . '&sort=name' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('design/layout', 'token=' . $this->session->data['mtoken'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['layout_id'])) {
			$data['action'] = $this->url->link('design/layout/add', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('design/layout/edit', 'token=' . $this->session->data['mtoken'] . '&layout_id=' . $this->request->get['layout_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('design/layout', 'token=' . $this->session->data['mtoken'] . $url, 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'design/layout')) {
