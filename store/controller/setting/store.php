...
class ControllerSettingStore extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('setting/store', 'token=' . $this->session->data['mtoken'], 'SSL'));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_setting_store->editStore($this->session->data['storeID'], $this->request->post);
			...
			$this->response->redirect($this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL')
		);

		$data['add'] = $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL');
		$data['delete'] = $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL');
		...
		$data['stores'][] = array(
			...
			'url'      => HTTP_CATALOG,
			'edit'     => $this->url->link('setting/setting', 'token=' . $this->session->data['mtoken'], 'SSL')
		);
		...
		foreach ($results as $result) {
			$data['stores'][] = array(
				...
				'name'     => $result['name'],
				'url'      => $result['url'],
				'edit'     => $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $result['store_id'], 'SSL')
			);
		}
	...
	public function getForm() {
		...
		if (!isset($this->request->get['store_id'])) {
			$data['action'] = $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL');
		} else {
			$data['action'] = $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL');
		}

		$data['cancel'] = $this->url->link('setting/store/edit', 'token=' . $this->session->data['mtoken'] . '&store_id=' . $this->session->data['storeID'], 'SSL');
	...
	protected function validateForm() {
		if (!$this->merchant->hasPermission('modify', 'setting/store')) {
