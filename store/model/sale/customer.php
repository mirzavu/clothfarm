...
class ModelSaleCustomer extends Model {
	...
	public function getCustomer($customer_id) {
		$query = $this->db->query("SELECT DISTINCT *, c.store_id as storeid FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_to_store cts ON (c.customer_id = cts.customer_id) WHERE cts.store_id = '". $this->session->data['storeID'] ."' AND c.customer_id = '" . (int)$customer_id . "'");
	...
	public function getCustomers($data = array()) {
		$sql = "SELECT *, CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.name AS customer_group FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_group_description cgd ON (c.customer_group_id = cgd.customer_group_id) LEFT JOIN " . DB_PREFIX . "customer_to_store cts ON (c.customer_id = cts.customer_id) WHERE cgd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND cts.store_id = '". $this->session->data['storeID'] ."'";
	...
	public function getTotalCustomers($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_to_store cts ON (c.customer_id = cts.customer_id) WHERE cts.store_id = '". $this->session->data['storeID'] ."'";
	...
	public function addHistory($customer_id, $comment) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_history SET customer_id = '" . (int)$customer_id . "', comment = '" . $this->db->escape(strip_tags($comment)) . "', date_added = NOW(), vendor_id = '". $this->session->data['storeID'] ."'");
	}
	...
	public function getHistories($customer_id, $start = 0, $limit = 10) {
		...
		$query = $this->db->query("SELECT comment, date_added FROM " . DB_PREFIX . "customer_history WHERE customer_id = '" . (int)$customer_id . "' AND vendor_id = '". $this->session->data['storeID'] ."' ORDER BY date_added DESC LIMIT " . (int)$start . "," . (int)$limit);

		return $query->rows;
	}

	public function getTotalHistories($customer_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_history WHERE customer_id = '" . (int)$customer_id . "' AND vendor_id = '". $this->session->data['storeID'] ."' ");
	...
	public function addTransaction($customer_id, $description = '', $amount = '', $order_id = 0) {
		...
		if ($customer_info) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "customer_transaction SET customer_id = '" . (int)$customer_id . "', order_id = '" . (int)$order_id . "', description = '" . $this->db->escape($description) . "', amount = '" . (float)$amount . "', date_added = NOW(), merchant_id = '". $this->session->data['storeID'] ."'");
	...
	public function getTransactions($customer_id, $start = 0, $limit = 10) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer_transaction WHERE customer_id = '" . (int)$customer_id . "' AND merchant_id = '". $this->session->data['storeID'] ."' ORDER BY date_added DESC LIMIT " . (int)$start . "," . (int)$limit);

		return $query->rows;
	}

	public function getTotalTransactions($customer_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total  FROM " . DB_PREFIX . "customer_transaction WHERE customer_id = '" . (int)$customer_id . "' AND merchant_id = '". $this->session->data['storeID'] ."'");

		return $query->row['total'];
	}

	public function getTransactionTotal($customer_id) {
		$query = $this->db->query("SELECT SUM(amount) AS total FROM " . DB_PREFIX . "customer_transaction WHERE customer_id = '" . (int)$customer_id . "' AND merchant_id = '". $this->session->data['storeID'] ."'");
