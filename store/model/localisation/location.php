...
class ModelLocalisationLocation extends Model {
	...
	public function getLocation($location_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "location WHERE location_id = '" . (int)$location_id . "' AND vendor_id = '".$this->session->data['storeID']."'");

		return $query->row;
	}

	public function getLocations($data = array()) {
		$sql = "SELECT location_id, name, address FROM " . DB_PREFIX . "location WHERE vendor_id = '".$this->session->data['storeID']."'";
	...
	public function getTotalLocations() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "location WHERE vendor_id = '".$this->session->data['storeID']."'");
