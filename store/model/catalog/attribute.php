...
class ModelCatalogAttribute extends Model {
	...
	public function getTotalAttributes() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "attribute a LEFT JOIN " . DB_PREFIX . "attribute_group_to_store ags ON (a.attribute_group_id = ags.attribute_group_id) WHERE ags.store_id='".$this->session->data['storeID']."'");
