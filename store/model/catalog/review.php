...
class ModelCatalogReview extends Model {
	...
	public function getReviews($data = array()) {
		$sql = "SELECT r.review_id, pd.name, r.author, r.rating, r.status, r.date_added FROM " . DB_PREFIX . "review r LEFT JOIN " . DB_PREFIX . "product_description pd ON (r.product_id = pd.product_id) JOIN " . DB_PREFIX . "product_to_store ps ON (r.product_id = ps.product_id) WHERE ps.store_id='".$this->session->data['storeID']."' AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
	...
	public function getTotalReviews($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "review r LEFT JOIN " . DB_PREFIX . "product_description pd ON (r.product_id = pd.product_id) JOIN " . DB_PREFIX . "product_to_store ps ON (r.product_id = ps.product_id) WHERE ps.store_id='".$this->session->data['storeID']."' AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
