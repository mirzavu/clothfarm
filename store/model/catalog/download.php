...
class ModelCatalogDownload extends Model {
	public function addDownload($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "download_to_store SET download_id = '" . (int)$download_id . "', store_id = '" . $this->session->data['storeID'] . "'");
	...
	public function getDownloads($data = array()) {		
		$sql = "SELECT * FROM " . DB_PREFIX . "download d LEFT JOIN " . DB_PREFIX . "download_description dd ON (d.download_id = dd.download_id) LEFT JOIN " . DB_PREFIX . "download_to_store ds ON (d.download_id = ds.download_id) WHERE ds.store_id='".$this->session->data['storeID']."' AND dd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
	...
	public function getTotalDownloads() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "download d LEFT JOIN " . DB_PREFIX . "download_to_store ds ON (d.download_id = ds.download_id) WHERE ds.store_id='".$this->session->data['storeID']."'");
