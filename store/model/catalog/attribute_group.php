...
class ModelCatalogAttributeGroup extends Model {
	public function addAttributeGroup($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_group_to_store SET attribute_group_id = '" . (int)$attribute_group_id . "', store_id = '" . $this->session->data['storeID'] . "'");
	...
	public function getTotalAttributeGroups() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "attribute_group ag LEFT JOIN " . DB_PREFIX . "attribute_group_to_store ags ON (ag.attribute_group_id = ags.attribute_group_id) WHERE ags.store_id='".$this->session->data['storeID']."' ");
