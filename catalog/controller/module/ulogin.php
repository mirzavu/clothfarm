...
class ControllerModuleUlogin extends Controller {
    ...
    public function index($setting) {
        ...
        $config = array(
            'providers' => ($this->config->get('ulogin_providers')==NULL)?array():$this->config->get('ulogin_providers'),
            'hidden' => ($this->config->get('ulogin_hidden')==NULL)?array():$this->config->get('ulogin_hidden'),
            'type' => $this->config->get('ulogin_type'),
            'redirect_uri' => $this->config->get('config_url').'ulogin.php',
