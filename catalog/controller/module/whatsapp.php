...
class ControllerModuleWhatsApp extends Controller  {
	private $moduleName = 'WhatsApp';
	private $moduleNameSmall = 'whatsapp';
	private $moduleData_module = 'whatsapp_module';
	private $moduleModel = 'model_module_whatsapp';
    ...
    public function index() {
		...
		if ($ajaxrequest == false) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/whatsapp.tpl')) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/whatsapp/whatsapp.tpl')) {
				return $this->load->view($this->config->get('config_template').'/template/module/whatsapp/'.$this->moduleNameSmall.'.tpl', $data);
			} else {
				return $this->load->view('default/template/module/whatsapp/'.$this->moduleNameSmall.'.tpl', $data);
			}
		}		
    }
