    ...
    $('#dsl_email_submit').on('click', function(){
      ...
      $.ajax({
          ...
          beforeSend: function() {
            ...
            $('#dsl_email_submit').after('<span class="wait">&nbsp;<img src="<?php echo $http; ?>catalog/view/theme/default/image/loading.gif" alt="" /></span>');
          },
          complete: function() {
...
$('#dsl_email_form select[name=\'country_id\']').bind('change', function() {
  ...
  $.ajax({
    ...
    dataType: 'json',
    beforeSend: function() {
      $('#dsl_email_form select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="<?php echo $http; ?>catalog/view/theme/default/image/loading.gif" alt="" /></span>');
    },
    complete: function() {
      $('.wait').remove();
    },      
