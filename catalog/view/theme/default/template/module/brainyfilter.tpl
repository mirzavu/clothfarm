    ...
    <div class="box bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
        ...
        <div class="brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
            <form class="bf-form 
                ...
                <?php if (isset($this->request->get['route']) && $this->request->get['route'] === 'product/search') : ?>
                ...
                <input type="hidden" name="manufacturer_id" value="<?php echo $this->request->get['manufacturer_id']; ?>" />
                <?php endif; ?>
                ...
                <?php if (!$isHorizontal || $settings['submission']['submit_type'] == 'button') : ?><div class="bf-buttonclear-box"<?php if ($isHorizontal && $settings['submission']['submit_button_type'] == 'float') : ?>style="display:none;"<?php endif; ?>>
                         <input type="button" value="<?php echo $lang_submit; ?>" class="button bf-buttonsubmit" onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;" <?php if ($settings['submission']['submit_button_type'] != 'fix' && $settings['submission']['submit_type'] != 'button' )  : ?>style="display:none;" <?php endif; ?> />
...
BrainyFilter.currentRoute = BrainyFilter.currentRoute || "<?php echo isset($this->request->get['route']) ? $this->request->get['route'] : ''; ?>";
