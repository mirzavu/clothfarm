<div class="panel-heading">
    <a data-toggle="collapse" href="#box-account">
        <span class="arrow-down">+</span>
        <span class="arrow-up">-</span> <?php echo $heading_title; ?>
    </a>
</div>
<div id="box-account" class="panel-collapse in">
    <div class="panel-body">
        <div class="list-group block block-account">
            <?php if (!$logged) { ?>
            ...
            <?php } ?>
            <a href="<?php echo $address; ?>" class="list-group-item"><?php echo $text_address; ?></a> <a href="<?php echo $wishlist; ?>" class="list-group-item"><?php echo $text_wishlist; ?></a> <a href="<?php echo $order; ?>" class="list-group-item"><?php echo $text_order; ?></a> <a href="<?php echo $download; ?>" class="list-group-item"><?php echo $text_download; ?></a>  <a href="<?php echo $return; ?>" class="list-group-item"><?php echo $text_return; ?></a>  <a href="<?php echo $newsletter; ?>" class="list-group-item"><?php echo $text_newsletter; ?></a>
            <?php if ($logged) { ?>
