<?php
    ...
    if ($layout_id == 3) {
        ...
        if (!isset($customisation_slider[$type_of_slider.'_type'][$store_id]) || $customisation_slider[$type_of_slider.'_type'][$store_id] == 'horizontal') {
        include('catalog/view/theme/slider_horizontal_carousel.php');
        } elseif ($customisation_slider[$type_of_slider.'_type'][$store_id] == 'vertical') {
        include('catalog/view/theme/slider_vertical.php');
        } else {
