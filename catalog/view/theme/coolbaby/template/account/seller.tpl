...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<div class="form-group required">
		...
		<fieldset>
          <legend><?php echo $text_plan_information; ?></legend>
           <div class="form-group required">
            
			<label class="col-sm-2 control-label" for="input-plan"><?php echo $entry_plan; ?></label>
			 <input type="hidden" name="plan_id" value="<?php echo $plan_id; ?>" /> 

			 <div class="col-sm-10">
			<?php  foreach ($plans as $plan) { ?>
					 <?php if ($plan['plan_id'] == $plan_id) { ?>
					<option value="<?php echo $plan['plan_id']; ?>"><?php echo $plan['plan_name']." - AED".$plan['plan_amount']." - ".$plan['plan_days']."Days"; ?></option>
					<?php }?>					
           ...
           <?php } ?>
			...
			<?php /*<label class="col-sm-2 control-label" for="input-plan"><?php echo $entry_plan; ?></label>
            <div class="col-sm-10">
              <select name="plan_id" id="input-plan" class="form-control">
                <option value=""><?php echo $text_select_plan; ?></option>
                <?php foreach ($plans as $plan) { ?>
					 <?php if ($plan['plan_id'] == $plan_id) { ?>
					<option value="<?php echo $plan['plan_id']; ?>" selected="selected"><?php echo $plan['plan_name']." - $".$plan['plan_amount']." - ".$plan['plan_days']."Days"; ?></option>
					<?php } else { ?>
					<option value="<?php echo $plan['plan_id']; ?>"><?php echo $plan['plan_name']." - $".$plan['plan_amount']." - ".$plan['plan_days']."Days"; ?></option>
					<?php } ?>
              ...
              <?php if ($error_plan) { ?>
              <div class="text-danger"><?php echo $error_plan; ?></div>
              <?php } ?>
            </div> */?>
          </div>
