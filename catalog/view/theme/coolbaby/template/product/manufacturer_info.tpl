...
echo $breadcrumbs;
?>
<div class="container manufacturer-info-page">
            <div class="row">
                <?php echo $content_top; ?>

                <div id="content" class="<?php echo ($customisation_products["product_listing_type"][$store_id] != 'small_without_column' && $customisation_products["product_listing_type"][$store_id] != 'slick_without_column' ? $class. ($column_left ? 'content-center' : '') : ($slick_enable ? 'content' : 'col-sm-12')); ?>">
