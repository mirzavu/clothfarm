            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="price"><?php if ($products[$product['product_id']]['price']) { ?>
                        ...
                        <span class="price old"><?php echo $products[$product['product_id']]['special']; ?></span>
                        <?php } ?>
                        <?php } ?></td>
                    <?php } ?>
                </tr>
                ...
                <tr>
                    <td></td>
                    <?php foreach ($products as $product) { ?>
                    <td><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block" onclick="cart_theme.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
