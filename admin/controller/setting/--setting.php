...
//    $statements = preg_replace("/\s/", ' ', $statements);
	...
	$data['tab_google'] = $this->language->get('tab_google');
		...
		$data['entry_facebook_app_token'] = $this->language->get('entry_facebook_app_token');
		...
		if (isset($this->error['telephone'])) {
		 ...
		 if (isset($this->error['facebook_app_id'])) {
			$data['error_facebook_app_id'] = $this->error['facebook_app_id'];
		} else {
			$data['error_facebook_app_id'] = '';
		}
		 if (isset($this->error['facebook_app_secret'])) {
			$data['error_facebook_app_secret'] = $this->error['facebook_app_secret'];
		} else {
			$data['error_facebook_app_secret'] = '';
		}
		 if (isset($this->error['facebook_app_token'])) {
			$data['error_facebook_app_token'] = $this->error['facebook_app_token'];
		} else {
			$data['error_facebook_app_token'] = '';
		}
		...
		$data['token'] = $this->session->data['token'];
		 ...
		 if (isset($this->request->post['config_facebook_app_secret'])) {
			$data['config_facebook_app_secret'] = $this->request->post['config_facebook_app_secret'];
		} else {
			$data['config_facebook_app_secret'] = $this->config->get('config_facebook_app_secret');
		}
		 if (isset($this->request->post['config_facebook_app_token'])) {
			$data['config_facebook_app_token'] = $this->request->post['config_facebook_app_token'];
		} else {
			$data['config_facebook_app_token'] = $this->config->get('config_facebook_app_token');
		}
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_email']) > 96) || !preg_match('/^[^\@]+@.*.[a-z]{2,15}$/i', $this->request->post['config_email'])) {
		 ...
		 if (!$this->request->post['config_paypal_merchant']) {
			$this->error['paypal_merchant'] = $this->language->get('error_paypal_merchant');
		}
		
		 if (!$this->request->post['config_facebook_app_id']) {
			$this->error['facebook_app_id'] = $this->language->get('error_facebook_app_id');
		}
		 if (!$this->request->post['config_facebook_app_secret']) {
			$this->error['facebook_app_secret'] = $this->language->get('error_facebook_app_secret');
		}
		 if (!$this->request->post['config_facebook_app_token']) {
			$this->error['facebook_app_token'] = $this->language->get('error_facebook_app_token');
		}
