...
class ControllerTicketsTickets extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('tickets/tickets', 'token=' . $this->session->data['token'], 'SSL'));
		}
	...
	public function add_list()
	{
		...
		$this->load->model('tickets/tickets');
			...
			$this->response->redirect($this->url->link('tickets/tickets/list_child', '&token=' . $this->session->data['token'] . '&ticket_id=' . $this->request->get['ticket_id'], 'SSL'));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('tickets/tickets', 'token=' . $this->session->data['token'] . '&ticket_id=' . $this->request->get['ticket_id'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('tickets/tickets/add', 'token=' . $this->session->data['token'], 'SSL');
		$data['delete'] = $this->url->link('tickets/tickets/delete', 'token=' . $this->session->data['token'], 'SSL');
		...
		foreach ($results as $result) {
			$data['tickets'][] = array(
				...
				'list_child'     => $this->url->link('tickets/tickets/list_child', 'token=' . $this->session->data['token'] . '&ticket_id=' . $result['ticket_id'], 'SSL'),
				'edit'     => $this->url->link('tickets/tickets/edit', 'token=' . $this->session->data['token'] . '&ticket_id=' . $result['ticket_id'], 'SSL')
			);
		}
	...
	public function list_child()
	{
		...
		if (!isset($this->request->get['ticket_id'])) {
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_form'),
				'href' => $this->url->link('tickets/tickets', 'token=' . $this->session->data['token'] . '&ticket_id=' . $this->request->get['ticket_id'], 'SSL')
			);
		}
		...
		if (!isset($this->request->get['ticket_id'])) {
			$data['action'] = $this->url->link('tickets/tickets', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('tickets/tickets/add_list', 'token=' . $this->session->data['token'] . '&ticket_id=' . $this->request->get['ticket_id'], 'SSL');
		}
		...
		$data['cancel'] = $this->url->link('tickets/tickets', 'token=' . $this->session->data['token'], 'SSL');
		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
	...
	public function getForm() {
		...
		if (!isset($this->request->get['ticket_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('tickets/tickets/add', 'token=' . $this->session->data['token'], 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_settings'),
				'href' => $this->url->link('tickets/tickets/edit', 'token=' . $this->session->data['token'] . '&ticket_id=' . $this->request->get['ticket_id'], 'SSL')
			);
		}
		...
		if (!isset($this->request->get['ticket_id'])) {
			$data['action'] = $this->url->link('tickets/tickets/add', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('tickets/tickets/edit', 'token=' . $this->session->data['token'] . '&ticket_id=' . $this->request->get['ticket_id'], 'SSL');
		}
