...
class ModelSaleReturn extends Model {
	...
	public function getReturns($data = array()) {
		$sql = "SELECT *, CONCAT(r.firstname, ' ', r.lastname) AS customer, st.name AS vendor, (SELECT rs.name FROM " . DB_PREFIX . "return_status rs WHERE rs.return_status_id = r.return_status_id AND rs.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status FROM `" . DB_PREFIX . "return` r LEFT JOIN " . DB_PREFIX . "store st on r.merchant_id = st.store_id ";
		...
		if (!empty($data['filter_store'])) {
			$implode[] = "r.merchant_id = '" . (int)$data['filter_store'] . "'";
		}
	...
	public function getTotalReturns($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "return`r LEFT JOIN " . DB_PREFIX . "store st on r.merchant_id = st.store_id ";
