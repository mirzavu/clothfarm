...
class ModelDesignBanner extends Model {
	...
	public function getBanners($data = array()) {
		$sql = "SELECT *, b.name AS name, st.name AS vendor FROM " . DB_PREFIX . "banner b LEFT JOIN " . DB_PREFIX . "store st on b.vendor_id = st.store_id ";
	...
	public function getTotalBanners() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "banner b LEFT JOIN " . DB_PREFIX . "store st on b.vendor_id = st.store_id ");
