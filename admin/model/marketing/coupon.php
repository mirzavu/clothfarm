...
class ModelMarketingCoupon extends Model {
	...
	public function getCoupons($data = array()) {
		$sql = "SELECT st.name AS vendor, c.coupon_id, c.name AS name, c.code, c.discount, c.date_start, c.date_end, c.status FROM " . DB_PREFIX . "coupon c LEFT JOIN " . DB_PREFIX . "store st on c.vendor_id = st.store_id";
	...
	public function getTotalCoupons() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "coupon c LEFT JOIN " . DB_PREFIX . "store st on c.vendor_id = st.store_id ");
