			 ...
			 <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="status" id="input-store" class="form-control">
                    <option  selected="selected" value="1"><?php echo $open; ?></option>
                    <option value="2" ><?php echo $closed; ?></option>
					<option value="3" ><?php echo $onhold; ?></option>
					<option value="4" ><?php echo $pending_customer; ?></option>
					<option value="5" ><?php echo $pending_vendor; ?></option>
                  </select>
                </div>
              </div>
          </div>
