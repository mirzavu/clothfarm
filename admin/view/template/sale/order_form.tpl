            ...
            <div class="tab-pane" id="tab-cart">
		      ...
		      <td class="text-left"><?php echo $column_vendor; ?></td>	
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
			 <td class="text-left"><?php if(!empty($order_product['vendor'])){ echo $order_product['vendor']; }else{ echo $text_admin; } ?></td>	
		...
		success: function(json) {
			...
			if (json['products']) {
				for (i = 0; i < json['products'].length; i++) { 
					...
					if(typeof(product['vendor']) != 'undefined' && product['vendor'] != 'NULL') { 
