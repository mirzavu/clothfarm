          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
			 <div class="form-group required">
			  ...
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-meta-title"><?php echo $entry_facebook_app_id; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_facebook_app_id" value="<?php echo $config_facebook_app_id; ?>" placeholder="<?php echo $entry_facebook_app_id; ?>" id="input-meta-title" class="form-control" />
                  <?php if ($error_facebook_app_id) { ?>
                  <div class="text-danger"><?php echo $error_facebook_app_id; ?></div>
                  <?php } ?>
                </div>
              </div>
			   <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-meta-title"><?php echo $entry_facebook_app_secret; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_facebook_app_secret" value="<?php echo $config_facebook_app_secret; ?>" placeholder="<?php echo $entry_facebook_app_secret; ?>" id="input-meta-title" class="form-control" />
                  <?php if ($error_facebook_app_secret) { ?>
                  <div class="text-danger"><?php echo $error_facebook_app_secret; ?></div>
                  <?php } ?>
                </div>
              </div>
			   <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-meta-title"><?php echo $entry_facebook_app_token; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_facebook_app_token" value="<?php echo $config_facebook_app_token; ?>" placeholder="<?php echo $entry_facebook_app_token; ?>" id="input-meta-title" class="form-control" />
                  <?php if ($error_facebook_app_token) { ?>
                  <div class="text-danger"><?php echo $error_facebook_app_token; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
