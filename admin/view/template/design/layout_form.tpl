            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <option <?php if ($layout_module['position'] == 'top_promo') : ?> selected="selected" <?php endif; ?> value="top_promo">Top full-width Promo Content</option>
                    <option <?php if ($layout_module['position'] == 'content_blog') : ?> selected="selected" <?php endif; ?> value="content_blog">Header TopLine</option>
                    <option <?php if ($layout_module['position'] == 'product_widget') : ?> selected="selected" <?php endif; ?> value="product_widget">Footer Universal Products Block</option>
                </select></td>
...
function addModule() {
    ...
    html += '    <option value="top_promo">Top full-width Promo Content</option>';
    html += '    <option value="content_blog">Header TopLine</option>';
    html += '    <option value="product_widget">Footer Universal Products Block</option>';
    html += '  </select></td>';
