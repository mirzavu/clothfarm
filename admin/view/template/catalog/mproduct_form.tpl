        ...
        <ul class="nav nav-tabs">
          ...
          <div class="tab-content">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for="input-fimage"><strong style="color:red">NEW! </strong>Featured image</label>
                <div class="col-sm-8">
                    <a href="" id="thumb-fimage" data-toggle="image" class="img-thumbnail">
                        <img src="<?php echo $fthumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
                    </a>
                    <input type="hidden" name="fimage" value="<?php echo $fimage; ?>" id="input-fimage" />
                </div>

                <label class="col-sm-4 control-label"><strong style="color:red">NEW! </strong>Use featured image in "Slick" type of sliders</label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                    <label class="col-sm-4 control-label">
                        ...
                        Enable/Disable Slick content in listings.
                    </label>
                    <div class="col-sm-8">
                        <label class="radio-inline">
                            <?php if ($slick_status) { ?>
                            <input type="radio" name="slick_status" value="1" checked="checked" />
                            <?php echo $text_yes; ?>
                            <?php } else { ?>
                            <input type="radio" name="slick_status" value="1" />
                            <?php echo $text_yes; ?>
                            <?php } ?>
                        </label>
                        <label class="radio-inline">
                            <?php if (!$slick_status) { ?>
                            <input type="radio" name="slick_status" value="0" checked="checked" />
                            <?php echo $text_no; ?>
                            <?php } else { ?>
                            <input type="radio" name="slick_status" value="0" />
                            <?php echo $text_no; ?>
                            <?php } ?>
                        </label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <label class="radio-inline">
                            <?php if ($product_page_type) { ?>
                            <input type="radio" name="product_page_type" value="1" checked="checked" />
                            Classic
                            <?php } else { ?>
                            <input type="radio" name="product_page_type" value="1" />
                            Classic
                            <?php } ?>
                        </label>
                        <label class="radio-inline">
                            <?php if (!$product_page_type) { ?>
                            <input type="radio" name="product_page_type" value="0" checked="checked" />
                            Creative
                            <?php } else { ?>
                            <input type="radio" name="product_page_type" value="0" />
                            Creative
                            <?php } ?>
                        </label>
                    </div>
...
<!--new options for product-->
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-slick_block<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_slick_block; ?>">
                                <?php echo $entry_slick_block; ?>
                            </span>
                            <div style="font-weight:normal;text-align:left">
                                for example, you can enter such content:<br>
                                &lt;img src="image/catalog/blocks/products/product25.jpg" alt=""&gt;<br>
                                &lt;div class="hover"&gt;&lt;/div&gt;<br>
                                &lt;div class="info top-left text-center"&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div class="inside"&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h6&gt;NEW&lt;/h6&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h2 class="underline"&gt;ARRIVALS&lt;/h2&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h4&gt;MEN CLOTHING&lt;/h4&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;a href="index.php" class="btn-cool btn-transparent"&gt;Shop now&lt;/a&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
                                &lt;/div&gt;<br>
                            </div>
                        ...
                        <div class="col-sm-8">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][slick_block]" placeholder="<?php echo $entry_slick_block; ?>" id="input-slick_block<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['slick_block'] : ''; ?></textarea>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-video1<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                                <span data-toggle="tooltip" title="<?php echo $help_video1; ?>">
                                <?php echo $entry_video1; ?>
                                </span>
                            <div style="font-weight:normal;">
                                About parameters of YouTube video player you can see here: <a target="_blank" href="https://developers.google.com/youtube/player_parameters">YouTube player</a><br>
                                (e.g. https://www.youtube.com/watch?v=jaWvdJBVBSc)
                            </div>
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-tab_title<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-html_product_tab<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-html_product_right<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_html_product_right; ?>">
                                <?php echo $entry_html_product_right; ?>
                            </span>
                        </label>
                        <div class="col-sm-8">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][html_product_right]" placeholder="<?php echo $entry_html_product_right; ?>" id="input-html_product_right<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['html_product_right'] : ''; ?></textarea>
                        </div>
                    </div>
                    <!--end custom blocks on product page-->

                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-short_description<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_short_description; ?>">
                                <?php echo $entry_short_description; ?>
                            </span>
                        </label>
                        <div class="col-sm-8">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][short_description]" placeholder="<?php echo $entry_short_description; ?>" id="input-short_description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                        </div>
                    </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="input-tag<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_tag; ?>"><?php echo $entry_tag; ?></span></label>
                    <div class="col-sm-8">
		...
		<div class="form-group">
                <label class="col-sm-2 control-label" for="input-vendor-shipping-rate"><?php echo $entry_vendor_shipping_rate; ?></label>
                <div class="col-sm-10">
                  <select name="vendor_shipping_rate_id" id="input-vendor-shipping-rate" class="form-control">
                    <option value="0"><?php echo $text_none; ?></option>
                    <?php foreach ($vendor_shipping_rates as $vendor_shipping_rate) { ?>
                    <?php if ($vendor_shipping_rate['vendor_shipping_rate_id'] == $vendor_shipping_rate_id) { ?>
                    <option value="<?php echo $vendor_shipping_rate['vendor_shipping_rate_id']; ?>" selected="selected"><?php echo $vendor_shipping_rate['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $vendor_shipping_rate['vendor_shipping_rate_id']; ?>"><?php echo $vendor_shipping_rate['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
                  ...
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <div class="checkbox">
                      <label>
                        ...
                        <input disabled type="checkbox" name="product_store[]" value="0" checked="checked" />
                    ...
                    <div class="checkbox">
                      <label>
                        ...
                        <input type="checkbox" id="vendorBox" name="product_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                        <?php echo $store['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" id="vendorBox" name="product_store[]" value="<?php echo $store['store_id']; ?>" />
                        <?php echo $store['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
...
$('#input-slick_block<?php echo $language['language_id']; ?>').summernote({height: 300});

$('#input-html_product_right<?php echo $language['language_id']; ?>').summernote({height: 300});


      $('#input-short_description<?php echo $language['language_id']; ?>').summernote({height: 300});
...
$('input#vendorBox').on('change', function() {		
	$('input#vendorBox').not(this).prop('checked', false); 		
	});
