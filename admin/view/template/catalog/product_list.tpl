...
<a href="<?php echo $export; ?>" data-toggle="tooltip" title="<?php echo $export_import; ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i></a>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <?php /*<label class="control-label" for="input-quantity"><?php echo $entry_quantity; ?></label>
		...
		<td class="text-left"><?php echo ucfirst($product['vendor']); ?></td>
