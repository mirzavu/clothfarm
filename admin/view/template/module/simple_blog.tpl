<?php echo $header; ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-simple-blog" class="form-horizontal">    
                        ...
                        <!--
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_simple_blog_image_width; ?></label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="simple_blog_image_width" value="<?php echo $simple_blog_image_width; ?>" class="form-control" style="width:auto" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_simple_blog_image_height; ?></label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="simple_blog_image_height" value="<?php echo $simple_blog_image_height; ?>" class="form-control" style="width:auto" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_simple_blog_short_description_length; ?></label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="simple_blog_short_description_length" value="<?php echo $simple_blog_short_description_length; ?>" class="form-control" style="width:auto" />
                            </div>
                        </div>
                        -->
                        <!--end eTheme changes-->
                                ...
                                <div class="tab-content">
                                    <?php foreach ($modules as $module) { ?>
                                        <div class="tab-pane" id="tab-module<?php echo $module['key']; ?>">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">Type of module</label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <select name="simple_blog_module[<?php echo $module['key']; ?>][module_type]" class="form-control">
                                                        <?php if ($module['module_type']) { ?>
                                                        <option value="1" selected="selected">Horizontal</option>
                                                        <option value="0">Vertical (for Product Widget)</option>
                                                        <?php } else { ?>
                                                        <option value="1">Horizontal</option>
                                                        <option value="0" selected="selected">Vertical (for Product Widget)</option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
		...
		function addModule() {
            ...
            html += '   <div class="form-group">';
            html += '       <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">Type of module</label>';
            html += '       <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">';
            html += '           <select name="simple_blog_module[' + token + '][module_type]" class="form-control">';
            html += '               <option value="1">Horizontal</option>';
            html += '               <option value="0">Vertical (for Product Widget)</option>';
            html += '           </select>';
            html += '       </div>';
            html += '   </div>';
