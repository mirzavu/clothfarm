      ...
      <div id="veinteractive_main">
        <div class="ve_header">
          ...
          <div class="faint-line">
            <div class="main_messages content_grid">
              <h2 class="thx-msg">
                <?php echo $VE_ERROR_INSTALLING_1 ?>
              </h2>
              <h2 class="conf-msg">
                <?php echo $VE_ERROR_INSTALLING_2 ?>
              </h2>
            </div>
          </div>
        ...
        <div class="ve_main">
          ...
          <div class="thanks_info content_grid">
            <div class="info_text">
              <p>
                <?php echo $VE_CONNECTION_ERROR_WITH_VEINTERACTIVE_1 ?>
                <a href='#' onclick='location.reload(true); return false;'>
                  <?php echo $VE_CONNECTION_ERROR_WITH_VEINTERACTIVE_2 ?>
                </a>
              </p>
              <p>&nbsp;</p>
              <p>
                <?php echo $VE_CONNECTION_ERROR_WITH_VEINTERACTIVE_DOUBT ?>
              </p>
