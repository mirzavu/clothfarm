                        ...
                        <div class="col-sm-10">
                            <select name="ulogin_type" class="form-control">
                                <?php foreach ($ulogin['type'] as $value): ?>
                                    <option value="<?php echo $value ?>" <?php echo (isset($config['ulogin_type'])) ? ($value == $config['ulogin_type']) ? 'selected="selected"' : '' : '' ?>><?php echo $value ?></option>
                                <?php endforeach; ?>                        
                            </select>
                        </div>
                    </div>
