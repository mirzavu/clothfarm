      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-limit_products"><?php echo $entry_limit_products; ?></label>
                <div class="col-sm-10">
                    <input type="text" name="limit_products" value="<?php echo $limit_products; ?>" placeholder="<?php echo $entry_limit_products; ?>" id="input-limit_products" class="form-control" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-2 control-label" for="status_size">Using of resized images.</label>
                <div class="col-sm-10">
                    <select onchange="getValResize(this);" name="status_size" id="status_size" class="form-control">
                        <?php if ($status_size) { ?>
                        <option value="1" selected="selected">Resizing of images</option>
                        <option value="0">Original sizes of images - "Bricks effect"</option>
                        <?php } else { ?>
                        <option value="1">Resizing of images</option>
                        <option value="0" selected="selected">Original sizes of images - "Bricks effect"</option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div id="resize" class="display_none">
                <div class="form-group">
            ...
            <script type="text/javascript">
                $current_val = $("#status_size option:selected").val();
                if ($current_val == 1) {
                    $("#resize").show();
                }
                function getValResize(sel) {
                    if (sel.value == 1){
                        $("#resize").show();
                    } else {
                        $("#resize").hide();
