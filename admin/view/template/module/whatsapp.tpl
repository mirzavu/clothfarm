...
<div id="content">
 <div class="page-header">
    <div class="container-fluid">
      <h1><i class="fa fa-pencil-square-o"></i>&nbsp;<?php echo $heading_title; ?></h1>
      <ul class="breadcrumb">
                    ...
                    <div class="form-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php foreach ($stores  as $st) { ?>
                                <li><a href="index.php?route=module/whatsapp&store_id=<?php echo $st['store_id'];?>&token=<?php echo $token; ?>"><?php echo $st['name']; ?></a></li>
                            <?php } ?> 
                        </ul>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"> 
                    ...
                    <div class="tabbable">
						...
						?>
                            <div id="main_settings" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/whatsapp/tab_settings.php'); ?></div>
                            <div id="control_panel" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/whatsapp/tab_controlpanel.php'); ?></div>
