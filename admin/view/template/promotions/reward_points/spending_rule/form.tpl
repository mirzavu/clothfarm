...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            ...
            <button type="button" data-toggle="tooltip" title="<?php echo $language->get('button_delete'); ?>" class="btn btn-danger" onclick="if(confirm('Are you sure want to delete this rule?')) location.href='<?php echo $url->link('promotions/reward_points/spendingRuleDelete', 'token=' . $token."&rule_id=".$rule_id, 'SSL'); ?>';"><i class="fa fa-trash-o"></i></button>
...
<div class="tab-pane" id="tab-rule-conditions">
    <div class="rule-tree">
        <div class="entry-head">
            <h4><?php echo $language->get('tab_sepnding_rule_actions_h4')?></h4>
        </div>
        <?php
            ...
            <ul class="rule-param-children">
                ...
                <li>
                                    <span class="rule-param rule-param-new-child">
                                        <a href="javascript:void(0)" class="label"><img src="view/image/rewardpoints/rule_component_add.gif" class="rule-param-add v-middle" alt="" title="Add"></a>
                                        <span class="element">
                                            <select id="conditions__<?php echo $counter?>__new_child" name="rule[conditions][<?php echo $counter?>][new_child]" class="element-value-changer select">
                                                ...
                                                <optgroup label="<?php echo $language->get('text_product_attribute')?>">
                                                ...
                                                <optgroup label="<?php echo $language->get('text_cart_attribute')?>">
    ...
    <div>
        ...
        <div id="rule_actions_fieldset">
            <div class="form-group required">
                ...
                <div class="col-sm-5">
                    <select id="rule_simple_action" name="actions" class="" class="form-control">
                        <option value="1" <?php echo ($actions == "1" ? 'selected=="selected"' : '')?>><?php echo $language->get('Do Not Allow to Use Reward Points')?></option>
                        <option value="2" <?php echo ($actions == "2" ? 'selected=="selected"' : '')?>><?php echo $language->get('Allow to Use Unlimited Points')?></option>
                        <option value="3" <?php echo ($actions == "3" ? 'selected=="selected"' : '')?>><?php echo $language->get('Allow to use fixed Reward Points (X) per order')?></option>
                        <option value="4" <?php echo ($actions == "4" ? 'selected=="selected"' : '')?>><?php echo $language->get('Spend (Y) to allow to use Reward Points (X)')?></option>
                    </select>
                </div>
            </div>
            <div class="form-group required">
