                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo $language->get('column_behavior_type')?></td>
                                <td class="text-center"><?php echo $language->get('column_reward_point')?></td>
                            ...
                            <?php $rule_url = $url->link('promotions/reward_points/behaviorRuleEdit', 'rule_id='.$rule['rule_id'].'&token=' . $token, 'SSL') ?>
                            <td class="text-left"><?php echo $rule['rule_id']?></td>
                            <td class="text-left"><?php echo $rule['name']?></td>
                            <td class="text-center">
                                <span class="behavior-customer-label"><?php echo $model_transaction->behaviorToText($rule['actions']);?></span>
                            </td>
                            <td class="text-center"><?php echo $rule['reward_point']?></td>
