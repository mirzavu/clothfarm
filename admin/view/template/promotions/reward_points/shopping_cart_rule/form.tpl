...
<div class="tab-pane " id="tab-rule-actions">
    <div>
        ...
        <div id="rule_actions_fieldset">
            <div class="form-group required">
                ...
                <div class="col-sm-5">
                    <select id="rule_simple_action" name="actions" class="form-control">
                        ...
                        <option value="2" <?php echo ($actions == "2" ? 'selected=="selected"' : '')?>><?php echo $language->get('Fixed Reward Points (X) for Whole Cart')?></option>
                        <!--<option value="3" <?php /*echo ($actions == "3" ? 'selected=="selected"' : '')*/?>><?php /*echo $language->get('Spend (Y) Get (X) Reward Points per item')*/?></option>-->
                        <option value="4" <?php echo ($actions == "4" ? 'selected=="selected"' : '')?>><?php echo $language->get('Spend (Y) Get (X) Reward Points for Whole Cart')?></option>
                    </select>
                </div>
            </div>
            <div class="form-group required">
            ...
            <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-name"><?php echo $language->get('Stop Further Rule Processing')?></label>
                <div class="col-sm-5">
                    <select name="stop_rules_processing" id="stop_rules_processing" class="form-control">
                        <option value="1" <?php echo ($stop_rules_processing == "1" ? 'selected=="selected"' : '')?>>No</option>
                        <option value="2" <?php echo ($stop_rules_processing == "2" ? 'selected=="selected"' : '')?>>Yes</option>
                    </select>
                </div>
            </div>
            <div class="form-group required">
                <label class="col-sm-2 control-label" class="form-control" for="input-name"><?php echo $language->get('Priority')?></label>
                <div class="col-sm-5">
                    <input type="text" name="rule_position" value="<?php echo $rule_position?>"/>
                </div>
            </div>
        </div>
    </div>
