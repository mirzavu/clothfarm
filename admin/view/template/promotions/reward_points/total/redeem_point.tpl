            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="redeem_point_status" id="input-status" class="form-control">
                                <?php if ($redeem_point_status) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="redeem_point_sort_order" value="<?php echo $redeem_point_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                </form>
            </div>
