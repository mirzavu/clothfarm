            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="earn_point_status" id="input-status" class="form-control">
                                <?php if ($earn_point_status) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="earn_point_sort_order" value="<?php echo $earn_point_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                </form>
            </div>
