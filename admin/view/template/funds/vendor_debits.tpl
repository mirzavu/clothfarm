  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a> 
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-debits').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
               <label class="control-label" for="input-status"><?php echo $entry_store; ?></label>
                <select name="filter_store" id="input-order-status" class="form-control">
                  <option value="*"></option>                 
                  <?php foreach ($stores as $stores) { ?>
                  <?php if ($stores['store_id'] == $filter_store) { ?>
		  ...
		  <td class="text-left"><?php echo $column_date_added; ?></td>	
		   <td class="text-left"><?php echo $column_reflects; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($debit['refund_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $debit['refund_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $debit['refund_id']; ?>" />
                    <?php } ?></td>
