...
<body>
    ...
    // NOT LOGGED IN
    //////////////////////////////////////////////////////////////////
	if (isset($_SESSION['OC_VERSION']) && $_SESSION['OC_VERSION'] >= '2.1.0.0') {
		$check = (isset($_SESSION['default']['user_id']) && (!empty($_SESSION['default']['user_id'])) && (!isset($_SESSION['user']))) ? true : false;
	} else {
		$check =  (isset($_SESSION['user_id']) && (!empty($_SESSION['user_id'])) && (!isset($_SESSION['user']))) ? true : false;
	}
	//// OPENCART LOGIN
	if ($check) {
